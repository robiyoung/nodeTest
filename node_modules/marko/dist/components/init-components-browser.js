...
var createFragmentNode = require("../morphdom/fragment")._Q_;
                ...
                if (firstChar === "^" || firstChar === "#") {
                    ...
                    if (firstChar === "^") {
                        ...
                        if (ownerComponent = componentLookup[ownerId]) {
                            keyedElements = ownerComponent.u_;
                        } else {
...
function initComponent(componentDef, doc) {
    ...
    if (domEvents) {
        ...
        domEvents.forEach(function (domEventArgs) {
            ...
            var eventEl = component.u_[domEventArgs[2]];
        ...
        if (eventListenerHandles.length) {
            component.i_ = eventListenerHandles;
        }
    }
...
function hydrateComponent(componentDef, doc) {
    ...
    if (rootNode) {
        ...
        component.u_ = keyedElementsByComponentId[componentId] || {};
